...
$sql = "SELECT * FROM product, category WHERE product_id = '$product_id' AND product.category = category.category_id";
    ...
    <main>
        <div class="row m-0 d-flex align-items-center">
            ...
            <div class="col-5 col-xl-6 col-xxl-7 py-5 d-flex flex-column align-items-center">
                <h1 class="h1 text-center fw-bold mb-3">Edit Product</h1>
                ...
                <form action="update_product.php" method="post" name="form1" enctype="multipart/form-data" class="col-12 col-xl-8 col-xxl-7">
                    ...
                    <input type="number" name="price" class="form-control mb-2" value="<?=$row['price']?>" required>
                    ...
                    <textarea type="text" name="description" class="form-control mb-2" value="<?=$row['description']?>" required></textarea>
