    ...
    <style>
        * {
        ...
        .card-body a {
            color: #8ec25e;
            background-color: transparent;
            border: 2px solid #8ec25e;
        }

        .card-body a:hover {
            color: white;
            background-color: #8ec25e;
        }
...
<body style="background-color: white;">
    ...
    <main class="py-5 my-5" style="background-color: white;">
        <div class="container pb-5">
            <div class="row px-4">
                <div class="col-xl-8 align-self-center py-5">
                    <div class=" py-1 px-2 rounded-pill mb-3">
                        <span class="d-inline align-text-center fs-6 fw-semibold" style="color: #8ec25e">
                            <i class="bi bi-bag-check-fill fs-5 me-3"></i>FREE SHIPPING FEE
                        </span>
                    </div>
                    <h1 class="display-1 fw-medium">Order</h1>
                    <h1 class="display-1 mb-4 fw-medium">Grocery Online</h1>
                    <p class="fs-6 text-start mb-5 mt-5">Get the best quality and the most delicious grocery food in the
                        world.<br>You can get them off use our website</p>
                    <a class="btn-main rounded-pill py-2 px-4" href="#">ORDER NOW</a>
                </div>
                <div class="col-xl-4 py-4">
                    <div class="rounded-circle" style="width: 420px; background-color: #d6e394;">
                        <img class="img-fluid" src="images/paper-bag-full.png" style="width: 420px;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container text-center py-5 px-5 rounded-5 mb-5" style="background-color: #d6e394">
            <h1 class="fw-bold mt-5 mb-3">Weekly Deals</h1>
            ...
            <div class="row gap-3 d-flex justify-content-xxl-center justify-content-start py-3 flex-nowrap" id="weeklydeals-container">
                <div class="card align-items-center rounded-4" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="rounded-pill text-decoration-none py-1 px-2">See more</a>
                    </div>
                </div>
                <div class="card align-items-center rounded-4" style="width: 18rem;">
                    <h6 class="position-relative px-3 py-1" style="left: -75px; top: 20px; background-color: #8ec25e; color: white;">Special Price</h6>
    ...
    <section>
        <div class="container py-5 my-5">
            <div class="row py-5">
                <div class="col-xl-6">
                    <div class="rounded-circle" style="width: 500px; height: 300px;">
                        <img class="img-fluid" src="images/delivery-truck.png" style="width: 500px;">
                    </div>
                </div>
                <div class="col-xl-5 mt-5 mt-xl-0">
                    <h1 class="display-4">Order Home</h1>
                    <h1 class="display-4 mb-5">Delivery Groceries</h1>
                    <p class="w-100">Order home delivery of groceries is a convenient and hassle-free way to get the
                        food and
                        household items you need without leaving your home.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container py-5 mb-5">
            <div class="card-group">
                <div class="card align-items-center bg-transparent">
                    <img src="images/delivery-paper-bag.png" class="card-img-top rounded-5 p-1">
                    <div class="card-body text-center">
                        <h5 class="card-title fw-medium mb-3">Pick Up Options</h5>
                        <p class="card-text">Skip the Wait and Collect Your Order at<br>Your Convenience.</p>
                    </div>
                </div>
                <div class="d-flex" style="height: 250px; background-color: #d6e394">
                    <div class="vr"></div>
                </div>
                <div class="card align-items-center bg-transparent">
                    <img src="images/scooter-delivery-bag.png" class="card-img-top rounded-5 p-1">
                    <div class="card-body text-center">
                        <h5 class="card-title fw-medium mb-3">Same Day Delivery</h5>
                        <p class="card-text">Get Your Items Delivered Right to<br>Your Doorstep Today.</p>
                    </div>
                </div>
                <div class="d-flex" style="height: 250px; background-color: #d6e394;">
                    <div class="vr"></div>
                ...
                <div class="card align-items-center bg-transparent">
                    <img src="images/heart-and-stethoscope.png" class="card-img-top rounded-5 p-1">
                    <div class="card-body text-center">
                        <h5 class="card-title fw-medium mb-3">Health & Safety</h5>
                        <p class="card-text">Your Well-being is Our Priority. Shop with Confidence and Peace of Mind.
                        </p>
                    </div>
                </div>
            </div>
